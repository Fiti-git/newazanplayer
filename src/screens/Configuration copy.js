  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          style={styles.input}
          onPress={() => selectedCountry === 'UAE' && setShowCityModal(true)}
        >
          <Text style={styles.inputText}>
        ...
        <TouchableOpacity
          style={styles.input}
          onPress={() => selectedCity === 'Dubai' && setShowAreaModal(true)}
        >
          <Text style={styles.inputText}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => {
                  ...
                  return isSelectable ? (
                    ...
                    <View>
                      <Text style={[styles.modalItem, { color: 'gray' }]}>{item}</Text>
                    </View>
                  );
                }}
              />
          ...
          <View style={styles.modalBackground}>
            <View style={styles.modalContent}>
              ...
              <FlatList
                ...
                keyExtractor={(item) => item}
                renderItem={({ item }) => {
                  const isSelectable = selectedCity === 'Dubai';
                  return isSelectable ? (
                    <TouchableOpacity
                      onPress={() => {
